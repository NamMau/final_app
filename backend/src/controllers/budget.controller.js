...
exports.createBudget = async (req, res) => {
    try {
        ...
        const budget = await budgetService.createBudget(userID, categoryID, amount, startDate, endDate);
...
exports.updateBudgetById = async (req, res) => {
    try {
        ...
        const updatedBudget = await budgetService.updateBudget(req.params.id, amount, startDate, endDate);
